                    ...
                    ElbowSubsystem* m_elbow, IntakeSubsystem* m_intake, LEDSubsystem* m_LED) 
{
    ...
    NamedCommands::registerCommand("Sendable Chooser 1", std::move(frc2::cmd::Print("sendable chooser 1")));
    NamedCommands::registerCommand("Sendable Chooser 2", std::move(frc2::cmd::Print("sendable chooser 2")));
